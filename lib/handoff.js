...
/**
 * Verification hand-off between PitCrew Mechanics and PitCrew.
 *
 * These are two surfaces of one product, not two products. A host who proved
 * they are a real Turo host on PitCrew Mechanics must not be asked to prove it again
 ...
 * host on PitCrew Mechanics at this time, by this method." PitCrew trusts it because
...
// The wire value, NOT a product name. PitCrew Mechanics was called HostPitCrew
// until the 2026-09-21 rename; the issuer string did not move with it and must
// not. It is what the other side signs into every claim, so renaming one side
// rejects every hand-off and renaming both rejects the claims already in
// flight. See docs/ECOSYSTEM.md § Identifiers that keep the old spelling.
...
/**
 * Mint a hand-off claim. Called on the PitCrew Mechanics side.
 *
 * @param {object} claim
